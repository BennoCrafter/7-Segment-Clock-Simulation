...
top_segment = Segment(id=0, top_left_position=(1, 0), bottom_right_position=(3, 0))
top_left_segment = Segment(id=1, top_left_position=(0, 1), bottom_right_position=(0, 2))
top_right_segment = Segment(
    id=2, top_left_position=(4, 1), bottom_right_position=(4, 2)
)
middle_segment = Segment(id=3, top_left_position=(1, 3), bottom_right_position=(3, 3))
bottom_left_segment = Segment(
    id=4, top_left_position=(0, 4), bottom_right_position=(0, 5)
)
bottom_right_segment = Segment(
    id=5, top_left_position=(4, 4), bottom_right_position=(4, 5)
)
bottom_segment = Segment(id=6, top_left_position=(1, 6), bottom_right_position=(3, 6))
segments = {
    segment.id: segment
    for segment in [
        top_segment,
...
class Display:
    ...
    def add_segment(self, segment: Segment, offset: int) -> None:
        width_range = range(
            segment.top_left_position[0] + offset,
            segment.bottom_right_position[0] + offset + 1,
        )
        height_range = range(
            segment.top_left_position[1], segment.bottom_right_position[1] + 1
        )
